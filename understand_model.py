...
def app():
    ...
    st.title('Understand our model!')

    # Model performance
    st.write('''
    After training and comparing several models, our best performing model was a random forest model with a r2 score of **0.88** and a rmse score of **182**.

    This means that we are 95% confident of that our prediction is within **+-$182/sqft**!

    Below, you can see which features are the most important in making the predictions!
    ''')
